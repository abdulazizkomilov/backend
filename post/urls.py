...
urlpatterns = [
    ...
    path('<uuid:pk>/comment/', api.post_create_comment,
    ...
    path('saved/<uuid:id>/', api.favourite_list, name='favourite_list'),
    path('get-me/', api.get_me, name='get_me'),
    path('create/', api.post_create, name='post_create'),
    path('trends/', api.get_trends, name='get_trends'),
    path('<uuid:pk>/save/', api.favourite_add, name='favourite_add'),
]
